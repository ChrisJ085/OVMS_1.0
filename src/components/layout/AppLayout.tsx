...
import { HelpSlideOverPanel } from '../../features/learning/components/HelpSlideOverPanel';
      ...
      <div className="h-screen bg-slate-900 flex text-slate-300 font-sans overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto p-4 md:p-6 bg-slate-900">
            <div className="w-full max-w-7xl 2xl:max-w-[1800px] mx-auto h-full transition-all duration-300">
              {siteReady ? (
                <>
